...
import 'package:steps_counter/widgets/collect_screen/card_element.dart';

Container firstCard(Size size, int steps) {
  return Container(
                ...
                Row(
                  ...
                  children: [
                    ...
                    Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        cardElement("0", Icons.attach_money, span: "usd"),
                        SizedBox(
                          height: 5,
                        ),
                    ...
                    Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        cardElement("$steps", Icons.nordic_walking_outlined),
                        SizedBox(
                          height: 5,
                        ),
